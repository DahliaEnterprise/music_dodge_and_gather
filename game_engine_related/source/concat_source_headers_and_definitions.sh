...
#scale
cat "./scale/scale_by_magnitude_xy.js_header" >> compiled_music_dodge_and_gather.js
#scene
...
#scale
cat "./scale/scale_by_magnitude_xy.js_definition" >> compiled_music_dodge_and_gather.js
#scenes
#scene major one
